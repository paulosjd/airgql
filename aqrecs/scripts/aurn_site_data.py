...
def get_site_info(site: str) -> dict:
    geo = site_geo[site]
    info = {'name': site, 'site_code': site_codes[site],
...
site_geo = {
    ...
    'Burton-on-Trent Horninglow': ['52.821050', '-1.635718'],
    ...
    'Derry Rosemount': ['55.002818', '-7.331179'],
    ...
    'Glasgow Townhead': ['55.865782', '-4.243631'],
    ...
    'Lough Navar': ['54.439510', '-7.900328'],
    ...
    'Telford Hollinswood': ['52.673471', '-2.436692'],
...
site_codes = {'Swansea Roadside': 'SWA1', 'Bath Roadside': 'BATH', 'London Haringey Priory Park South': 'HG4',
              ...
              'Mace Head': 'MH', 'Ballymena Antrim Road': 'BAAR', 'Oxford Centre Roadside': '468',
              ...
              'Cardiff Centre': 'CARD', 'Lough Navar': 'LNVR', 'Telford Hollinswood': 'TELF',
              'Burton-on-Trent Horninglow': 'BRTN'}
...
site_environs = {
    ...
    'Burton-on-Trent Horninglow': 'urban-background',
    ...
    'Derry Rosemount': 'urban-background',
    ...
    'Glasgow Townhead': 'urban-background',
    ...
    'Telford Hollinswood': 'urban-background',
...
regions = {
    ...
    'Burton-on-Trent Horninglow': 'east-midlands',
    ...
    'Derry Rosemount': 'northern-ireland',
    ...
    'Glasgow Townhead': 'central-scotland',
    ...
    'Telford Hollinswood': 'west-midlands',
    'Thurrock': 'eastern',
